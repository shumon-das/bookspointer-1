...
const WriteScreen: React.FC<Props> = () => {
  ...
  useLayoutEffect(() => { navigation.setOptions({ headerShown: true, title: labels.textEditor, headerTintColor: '#d4d4d4', headerStyle: { backgroundColor: '#085a80' }, headerTitleStyle: { color: 'white' } });}, []);
