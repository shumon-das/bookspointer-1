import { Text, View, Image, SafeAreaView, BackHandler, ScrollView, ActivityIndicator, TouchableOpacity } from 'react-native'
    ...
    navigation.setOptions({
      headerRight: () => (
        <TouchableOpacity onPress={() => setShowPopover(true)}>
          <Icon name="ellipsis-v" size={20} style={{paddingHorizontal: 15}}></Icon>
        </TouchableOpacity>
      ),
    })
  })
      ...
      <View>
        ...
        >
          <Text style={{ width: 160,paddingVertical: 10, paddingLeft: 10, paddingRight: 25 }}
            onPress={() => alert('')}
          > 
            <Icon name='lock' size={18}></Icon> {labels.resetPassword}
          </Text>
          <Text style={{ width: 160,paddingVertical: 10, paddingLeft: 10, paddingRight: 25 }}
            onPress={() => alert('should update the publish status')}
          > 
            <Icon name='user' size={18}></Icon> {labels.editProfile}
          </Text>
          <Text style={{ width: 160,paddingVertical: 10, paddingLeft: 10, paddingRight: 25 }}
            onPress={() => {
              logout()
          ...
          > 
            <Icon name='sign-out' size={18} style={{marginRight: 10}}></Icon> 
